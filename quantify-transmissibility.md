...
``` output
                        measure               estimate
                         <char>                 <char>
1:       New infections per day   7975 (4758 -- 13121)
2:   Expected change in reports                 Stable
3:   Effective reproduction no.     0.96 (0.74 -- 1.2)
4:               Rate of growth -0.012 (-0.1 -- 0.076)
5: Doubling/halving time (days)      -58 (9.2 -- -6.9)
```

As these estimates are based on partial data, they have a wide uncertainty interval.

+ From the summary of our analysis we see that the expected change in reports is Stable with the estimated new infections 7975 (4758 -- 13121).
...
+ The doubling time (the time taken for case numbers to double) is -58 (9.2 -- -6.9).

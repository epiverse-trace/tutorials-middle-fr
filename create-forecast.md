...
``` output
WARN [2026-04-14 02:02:18] epinow: There were 3 divergent transitions after warmup. See
https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
to find out why this is a problem and how to eliminate them. - 
WARN [2026-04-14 02:02:18] epinow: There were 495 transitions after warmup that exceeded the maximum treedepth. Increase max_treedepth above 12. See
https://mc-stan.org/misc/warnings.html#maximum-treedepth-exceeded - 
WARN [2026-04-14 02:02:18] epinow: Examine the pairs() plot to diagnose sampling problems
 - 
WARN [2026-04-14 02:02:19] epinow: The largest R-hat is NA, indicating chains have not mixed.
Running the chains for more iterations may help. See
https://mc-stan.org/misc/warnings.html#r-hat - 
WARN [2026-04-14 02:02:20] epinow: Bulk Effective Samples Size (ESS) is too low, indicating posterior means and medians may be unreliable.
Running the chains for more iterations may help. See
https://mc-stan.org/misc/warnings.html#bulk-ess - 
WARN [2026-04-14 02:02:20] epinow: Tail Effective Samples Size (ESS) is too low, indicating posterior variances and tail quantiles may be unreliable.
Running the chains for more iterations may help. See
...
``` output
                        measure                  estimate
                         <char>                    <char>
1:       New infections per day    20197 (13448 -- 30518)
2:   Expected change in reports         Likely decreasing
3:   Effective reproduction no.        0.97 (0.77 -- 1.2)
4:               Rate of growth -0.0098 (-0.091 -- 0.069)
5: Doubling/halving time (days)          -71 (10 -- -7.6)
```
...
4:               Rate of growth 0.04 (0.0034 -- 0.087)
5: Doubling/halving time (days)          17 (8 -- 200)
```

Le numéro de reproduction effectif $R_t$ (à la dernière date des données) est de 1.6 (1.2 -- 2.4). Le taux de croissance exponentiel du nombre de cas est de 0.04 (0.0034 -- 0.087).

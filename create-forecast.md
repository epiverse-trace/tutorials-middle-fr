...
``` output
WARN [2026-04-07 01:40:36] epinow: There were 3 divergent transitions after warmup. See
https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
to find out why this is a problem and how to eliminate them. - 
WARN [2026-04-07 01:40:36] epinow: Examine the pairs() plot to diagnose sampling problems
 - 
```
...
``` output
                        measure                 estimate
                         <char>                   <char>
1:       New infections per day   19965 (13339 -- 30032)
2:   Expected change in reports        Likely decreasing
3:   Effective reproduction no.       0.96 (0.77 -- 1.2)
4:               Rate of growth -0.013 (-0.093 -- 0.068)
5: Doubling/halving time (days)         -52 (10 -- -7.5)
```
...
``` output
WARN [2026-04-07 01:45:46] epinow: There were 2 divergent transitions after warmup. See
https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
to find out why this is a problem and how to eliminate them. - 
WARN [2026-04-07 01:45:46] epinow: Examine the pairs() plot to diagnose sampling problems
 - 
```
...
``` output
                        measure                estimate
                         <char>                  <char>
1:       New infections per day          94 (49 -- 196)
2:   Expected change in reports              Increasing
3:   Effective reproduction no.        1.6 (1.1 -- 2.4)
4:               Rate of growth 0.041 (0.0032 -- 0.089)
5: Doubling/halving time (days)         17 (7.7 -- 210)
```

Le numéro de reproduction effectif $R_t$ (à la dernière date des données) est de 1.6 (1.1 -- 2.4). Le taux de croissance exponentiel du nombre de cas est de 0.041 (0.0032 -- 0.089).
